...
/* Private variables ---------------------------------------------------------*/
/* Definitions for buzz01 */
osThreadId_t buzz01Handle;
const osThreadAttr_t buzz01_attributes = {
  .name = "buzz01",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for buzz02 */
osThreadId_t buzz02Handle;
const osThreadAttr_t buzz02_attributes = {
  .name = "buzz02",
  .stack_size = 128 * 4,
...
/* USER CODE BEGIN Header_StartBuzzer01 */
/**
 * @brief  Function implementing the buzz01 thread.
...
/* USER CODE BEGIN Header_StartBuzzer02 */
/**
 * @brief Function implementing the buzz02 thread.
 * @param argument: Not used
 * @retval None
 */
